//+------------------------------------------------------------------+
//|                          B-Kijun_C1-fx_snipers_C2-Trix_V-WAE.mq4 |
//|                                               Martin Aleksandrov |
...
void Algo()
{
   ...
   //Crossline
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\fx_snipers_ergodic_cci_trigger",0,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\fx_snipers_ergodic_cci_trigger",1,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\fx_snipers_ergodic_cci_trigger",0,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\fx_snipers_ergodic_cci_trigger",1,2);
