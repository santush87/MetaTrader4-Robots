//+------------------------------------------------------------------+
//|                                 B-Kijun_C1-RSI_C2-Trix_V-WAE.mq4 |
//|                                               Martin Aleksandrov |
...
extern double WhenToTrailATR = 1;
extern double TrailAmountATR = 1;
...
void Algo()
{
   ...
   //0-Line
   double line = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\trix",trixDepth,0,1);
   double prevLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\trix",trixDepth,0,2);
   
   //Exit Indi
   //double exitBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\absolute-strength-timeframe-indicator",0,1);
   //double exitSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\absolute-strength-timeframe-indicator",1,1);
   //double exitPrevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\absolute-strength-timeframe-indicator",0,2);
   //double exitPrevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\absolute-strength-timeframe-indicator",1,2);
