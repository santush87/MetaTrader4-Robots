...
void Rex()
{
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Rex",0,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Rex",1,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Rex",0,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Rex",1,2);
