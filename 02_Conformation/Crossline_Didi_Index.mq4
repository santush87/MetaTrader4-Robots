...
void Didi()
{
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Didi_Index",0,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Didi_Index",2,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Didi_Index",0,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Didi_Index",2,2);
