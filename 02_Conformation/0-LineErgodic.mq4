...
void Ergo()
{
   double line = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\ergodic",0,1);
   double prevLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\ergodic",0,2);
