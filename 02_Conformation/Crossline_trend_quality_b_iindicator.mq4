//+------------------------------------------------------------------+
//|                         Crossline trend_quality_b_iindicator.mq4 |
//|                                               Martin Aleksandrov |
...
void Tre()
{
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\trend_quality_b_iindicator",1,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\trend_quality_b_iindicator",0,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\trend_quality_b_iindicator",1,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\trend_quality_b_iindicator",0,2);
