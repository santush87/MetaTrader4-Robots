//+------------------------------------------------------------------+
//|                             0-Line True Direction Oscillator.mq4 |
//|                                               Martin Aleksandrov |
...
void Tru()
{
   double line = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\True Direction Oscillator",0,1);
   double prevLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\True Direction Oscillator",0,2);
