...
void QQE()
{
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\QQE_with_Alerts",0,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\QQE_with_Alerts",1,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\QQE_with_Alerts",0,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\QQE_with_Alerts",1,2);
