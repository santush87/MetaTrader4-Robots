...
void Trend()
{
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Trend_Thrust",0,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Trend_Thrust",1,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Trend_Thrust",0,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Trend_Thrust",1,2);
