...
void Aarun()
{
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\aroon_up_down",0,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\aroon_up_down",1,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\aroon_up_down",0,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\aroon_up_down",1,2);
