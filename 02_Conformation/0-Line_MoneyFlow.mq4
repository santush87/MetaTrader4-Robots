...
void Money()
{
   double line = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Money Flow",0,1);
   double prevLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Money Flow",0,2);
