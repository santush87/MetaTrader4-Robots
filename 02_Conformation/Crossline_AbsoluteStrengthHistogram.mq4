//+------------------------------------------------------------------+
//|                        Crossline Absolute Strength Histogram.mq4 |
//|                                               Martin Aleksandrov |
...
void Ash()
{
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Absolute Strength Histogram",0,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Absolute Strength Histogram",1,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Absolute Strength Histogram",0,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Absolute Strength Histogram",1,2);
