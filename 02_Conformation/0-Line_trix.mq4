...
void Trix()
{
   double line = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\trix",0,1);
   double prevLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\trix",0,2);
