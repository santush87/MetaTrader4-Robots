//+------------------------------------------------------------------+
//|                   0-Line Detrended Accumulation Distribution.mq4 |
//|                                               Martin Aleksandrov |
...
void Detrended()
{
      double line = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Detrended Accumulation Distribution",0,1);
      double prevLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Detrended Accumulation Distribution",0,2);
