...
void Ich()
{
   double buyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Ich_Disparity",0,1);
   double sellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Ich_Disparity",1,1);
   double prevBuyLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Ich_Disparity",0,2);
   double prevSellLine = iCustom(NULL,0,"Examples\\3. Confirmation Indicators\\Ich_Disparity",1,2);
